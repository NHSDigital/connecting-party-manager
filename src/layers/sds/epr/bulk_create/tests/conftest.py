...
def mhs_1() -> NhsMhs:
    return NhsMhs(
        ...
        nhsmhssvcia="sn-123:in-123",
        nhsmhsendpoint="https://my-fqdn",
        uniqueidentifier="AAA-123456:sn-123:in-123",
        ...
        nhsmhscpaid="AAA-123456:sn-123:in-123",
        nhsmhsfqdn="my-fqdn",
        nhsmhsin="in-123",
...
def mhs_2() -> NhsMhs:
    return NhsMhs(
        ...
        nhsmhssvcia="sn-456:in-456",
        nhsmhsendpoint="https://my-fqdn2",
        uniqueidentifier="BBB-123456:sn-456:in-456",
        ...
        nhsepinteractiontype="hl7",
        nhsmhscpaid="BBB-123456:sn-456:in-456",
        nhsmhsfqdn="my-fqdn2",
        nhsmhsin="in-456",
        nhsmhsisauthenticated="none",
        nhsmhssn="sn-456",
