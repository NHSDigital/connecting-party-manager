        ...
        for _raw_message_set_data in (
            {
                ...
                "MHS IN": "in-123",
                "MHS SN": "sn-123",
                "MHS CPA ID": "my-cpa-id-1",
                "Unique Identifier": "my-cpa-id-1",
            },
            {
                "Interaction ID": "my-other-interaction-id",
                "MHS IN": "in-456",
                "MHS SN": "sn-456",
                "MHS CPA ID": "my-cpa-id-2",
                "Unique Identifier": "my-cpa-id-2",
            },
        )
    ]
...
@pytest.fixture(scope="module")
def mhs_device(product, party_key, message_sets: DeviceReferenceData):
...
def test_create_epr_product_team_exceptional_ods_code(ods_code: str, today_string: str):
