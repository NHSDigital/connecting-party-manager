...
# @pytest.mark.integration
# def test_repository_add_and_delete_one_transaction(repository: MyRepository):
#     value = "123"
#     my_item = MyModel(
#         field=value, events=[MyEventAdd(field=value), MyEventDelete(field=value)]
#     )
#     repository.write(my_item)
...
# @pytest.mark.integration
# def test_repository_add_and_delete_and_add_one_transaction(repository: MyRepository):
#     value = "123"
#     my_item = MyModel(
#         field=value,
#         events=[
#             MyEventAdd(field=value),
#             MyEventDelete(field=value),
#             MyEventAdd(field=value),
#         ],
#     )
#     repository.write(my_item)
#     assert repository.read(pk=value) == my_item
