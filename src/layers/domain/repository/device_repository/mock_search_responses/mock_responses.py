...
device_5NR_result = [
    {
        **device_head,
        "questionnaire_responses": {
            "spine_device/1/2014-01-01:01": [
                {
                    "questionnaire": ["spine_device", "1"],
                    "status": "active",
                    "responses": [
                        {"object_class": ["nhsAs"]},
                        {"unique_identifier": ["010057927542"]},
                        ...
                        {
                            "nhs_mhs_end_point": [
                                "https://systmonespine1.tpp.nme.ncrs.nhs.uk/SystmOneMHS/NHSConnect/5NR/STU3/1"
                            ]
                        },
            ...
            "spine_device/1/2014-01-01:01": [
                {
                    ...
                    "responses": [
                        {"object_class": ["nhsAs"]},
                        {"unique_identifier": ["798706756516"]},
                        {"nhs_approver_urp": ["System"]},
                        {"nhs_contract_property_template_key": ["17"]},
                        {"nhs_date_approved": ["20211118094930"]},
                        {"nhs_date_dns_approved": ["20211118094930"]},
                        ...
                        {"nhs_product_key": ["5952"]},
                        {"nhs_product_name": ["Lorenzo Regional Care"]},
                        {"nhs_product_version": ["R2"]},
                        {
                            "nhs_requestor_urp": [
                                "uniqueidentifier=688491328565,uniqueidentifier=495227626043,uid=709580513048,ou=people, o=nhs"
                            ]
            ...
            "spine_endpoint/1/2014-01-01:01": [
                {
                    ...
                    "responses": [
                        ...
                        {
                            "nhs_mhs_svc_ia": [
                                "urn:nhs:names:services:gpconnect:fhir:rest:read:location-1"  # pragma: allowlist secret
                            ]
                        },
                        ...
                        {"nhs_mhs_persist_duration": ["PT4M"]},
                        {"nhs_mhs_retry_interval": ["PT2S"]},
                        {"nhs_mhs_retries": [2]},
                    ],
                }
            ]
...
endpoint_5NR_result = endpoint_RTX_result
