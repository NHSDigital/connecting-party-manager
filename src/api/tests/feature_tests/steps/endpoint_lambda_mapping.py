...
def get_endpoint_lambda_mapping() -> ENDPOINT_LAMBDA_MAPPING:
    ...
    return {
        "POST": {
            ...
            "ProductTeam/{product_team_id}/Product/{product_id}/{env}/DeviceReferenceData": api.createDeviceReferenceData.index,
            "ProductTeam/{product_team_id}/Product/{product_id}/{env}/DeviceReferenceData/AccreditedSystemsAdditionalInteractions": api.createDeviceReferenceDataASActions.index,
        ...
        "GET": {
            ...
            "ProductTeam/{product_team_id}/Product/{product_id}/{env}/DeviceReferenceData": api.searchDeviceReferenceData.index,
            "ProductTeam/{product_team_id}/Product/{product_id}/{env}/DeviceReferenceData/{device_reference_data_id}": api.readDeviceReferenceData.index,
            "ProductTeam/{product_team_id}/Product/{product_id}/{env}/Device/{device_id}": api.readDevice.index,
