Feature: Read EPR Product - success scenarios
  These scenarios demonstrate successful EPR Product reads
  ...
  Scenario Outline: Read an existing EprProduct
    ...
    When I make a "GET" request with "default" headers to "ProductTeamEpr/<product_team_id>/ProductEpr/<product_id>"
