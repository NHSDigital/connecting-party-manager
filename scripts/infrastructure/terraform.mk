...
initialise--mgmt: ## Bootstrap the MGMT AWS environment. Must provide PREFIX and VERSION keyword arguments.
	@bash $(PATH_TO_INFRASTRUCTURE)/initialise-mgmt-resources.sh $(PREFIX) $(VERSION)
