...
policy_name="NHSDevelopmentPolicy"
role_name="NHSDevelopmentRole"
...
for policy_number in "1" "2"; do
  tf_policy=$(_substitute_environment_variables ./scripts/infrastructure/policies/development${policy_number}-policy.json)
