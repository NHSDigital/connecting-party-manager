Feature: Create EPR Product - failure scenarios
  These scenarios demonstrate failures to create a new EPR Product
  ...
  Scenario: Cannot create a EPR Product with a EPR Product that is missing fields (no name) and has extra param
  ...
  Scenario: Cannot create a EPR Product with a EPR Product that is missing fields (no name)
    Given I have already made a "POST" request with "default" headers to "ProductTeamEpr" with body:
      | path             | value                 |
      | name             | My Great Product Team |
      | ods_code         | F5H1R                 |
  ...
  Scenario: Cannot create a EPR Product for EPR with an invalid body (extra parameter is not allowed)
    Given I have already made a "POST" request with "default" headers to "ProductTeamEpr" with body:
      | path             | value                 |
      | name             | My Great Product Team |
      | ods_code         | F5H1R                 |
  ...
  Scenario: Cannot create a EPR Product with corrupt body
    Given I have already made a "POST" request with "default" headers to "ProductTeamEpr" with body:
      | path             | value                 |
      | name             | My Great Product Team |
      | ods_code         | F5H1R                 |
  ...
  Scenario: Cannot create a EPR Product with a Product Team that does not exist
    When I make a "POST" request with "default" headers to "ProductTeamEpr/f9518c12-6c83-4544-97db-d9dd1d64da97/ProductEpr" with body:
      | path | value            |
      | name | My Great Product |
